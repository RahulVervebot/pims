...
export default function CheckoutScreen() {
  ...
  const validate = () => {
    ...
    // Basic address check (customize to your needs)
  ...
  const onConfirm = async () => {
    try {
      ...
      // 1) Get userId (adjust key if you store differently)
      ...
      // 3) Build payload per backend contract
      const body = {
        userId: storedUserId,
        ...
        items,
        // Do NOT send subtotal/tax/total; server computes them.
      };
